export const makeConsumerImpl = (kafka, consumerConfig) =>
  kafka.consumer(consumerConfig);

export const connectImpl = (consumer) => () => consumer.connect();

export const subscribeImpl = (consumer, subscriptionConfig) => () =>
  consumer.subscribe(subscriptionConfig);

export const eachBatchImpl =
  (consumer, eachBatchAutoResolve, autoCommit, handler) => () => {
    return consumer.run({
      autoCommit,
      ...
      eachBatch: ({
        ...
        return handler(
          ...
          resolveOffsetEff,
          heartbeat,
          commitOffsetsIfNecessaryEff,
          uncommittedOffsetsEff,
          isRunningEff,
          isStaleEff,
        )();
      },
